...
int Main(const std::vector<std::string>& _args) {
	...
	/* Initializing a window using an GameLoop Event Loop Type (Remember - they can be dynamically changed) */
	OWL::Window window(&context, "OWL Software EventLoop Example", OWL::Vec2i(0), OWL::Vec2ui(1280, 720), OWL::EventLoopType::GameLoop);
